  ...
  return (
    <section className="mx-auto max-w-content px-6 pb-16 pt-16 md:pb-24 md:pt-24">
      <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        <div>
          <Eyebrow>GİZLİ MÜŞTERİ DENETİMİ • PERSONEL EĞİTİMİ</Eyebrow>

          <h1 className="mt-5 font-serif text-5xl leading-[1.05] tracking-tight md:text-6xl lg:text-7xl">
            Misafiriniz her şeyi görür. Biz de öyle.
          </h1>

          <p className="mt-6 max-w-xl text-base leading-relaxed text-ink-muted md:text-lg">
            Sektörde üst düzey yöneticilik yapmış denetçilerimiz, tesisinize misafir olarak gelir;
            vaat ettiğiniz marka standardı ile sahada yaşanan gerçek arasındaki boşluğu ölçer, gelir
            kaçaklarını rakamlarla önünüze koyar.
          </p>
