    ...
    <main className="mx-auto max-w-content px-6 py-16 md:py-24">
      <Reveal>
        <header className="max-w-2xl">
          ...
          <p className="mt-6 text-base leading-relaxed text-ink-muted md:text-lg">
            ...
            yönlendirin. Toplam {total} kriter; her biri bir kanıt türüne bağlı.
          </p>
      ...
      <div className="mt-14 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {modules.map((module, index) => (
          <Reveal key={module.code} delay={Math.min(index, 5) * 0.04} className="h-full">
      ...
      <Reveal className="mt-16">
        <Card tone="surface" className="flex flex-col gap-4 md:p-8">
          ...
          <p className="max-w-3xl text-sm leading-relaxed text-ink-muted md:text-base">
            ...
            paylaşılır, üçüncü taraflara aktarılmaz.
          </p>
        </Card>
      </Reveal>
    </main>
